...
pub enum DBStatisticsTickerType {
    ...
    DbMutexOwnMicrosByOther = 145,
    DbMutexOwnMicrosByUserApi = 146,
    DbMutexOwnMicrosByCompaction = 147,
    DbMutexOwnMicrosBySstInject = 148,
    DbMutexOwnMicrosByFlushMemtable = 149,
    TitanNumGet = 150,
    TitanNumSeek,
    TitanNumNext,
    TitanNumPrev,
